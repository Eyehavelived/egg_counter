...
class App(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.crop_cat.grid(row=self.current_row, column=0, pady=self.PADDING, padx=self.PADDING, columnspan=2)
        ...
        self.w_label.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING)
        self.w_crop_entry.grid(row=self.current_row, column=1, pady=self.PADDING, padx=self.PADDING)
        ...
        self.contrast_cat.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING, columnspan=2)
        ...
        self.beta_label.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING)
        self.brightness_entry.grid(row=self.current_row, column=1, pady=5, padx=5)
        self.beta_desc.grid(row=self.next_row(), column=0, pady=1, padx=self.PADDING, columnspan=2)
        ...
        self.circle_cat.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING, columnspan=2)
        ...
        self.p2_label.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING)
        self.circ_p2_entry.grid(row=self.current_row, column=1, pady=self.PADDING, padx=self.PADDING)
        ...
        self.circ_max_label.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING)
        self.circ_max_entry.grid(row=self.current_row, column=1, pady=self.PADDING, padx=self.PADDING)
        ...
        self.marker_cat.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING, columnspan=2)
        self.marker_size_label.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING)
        self.marker_size_entry.grid(row=self.current_row, column=1, pady=self.PADDING, padx=self.PADDING)
        ...
        self.blob_cat.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING, columnspan=2)
        ...
        self.min_convexity_label.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING)
        self.min_convexity_entry.grid(row=self.current_row, column=1, pady=self.PADDING, padx=self.PADDING)
        ...
        self.min_area_label.grid(row=self.next_row(), column=0, pady=self.PADDING, padx=self.PADDING)
        self.min_area_entry.grid(row=self.current_row, column=1, pady=self.PADDING, padx=self.PADDING)

        # finally, the buttons
        self.preview_button = tk.Button(text="Preview", command=self.preview, bg='brown', fg='white')
        self.batch_button = tk.Button(text='Batch Process', command=self.run_blob_test, bg='brown', fg='white')
        self.preview_button.grid(row=self.next_row(), column=0, pady=self.PADDING * 2, padx=self.PADDING * 2)
